...
It gives us a piece of precious information about the motivations behind the creation of Go. 
Build times were too long and painful... 
they had to find a way to avoid them; that was Go Genesis’ entry point.

Robert Griesemer, Ken Thompson, and Rob Pike are the developers that started working on Go back in 2007. 
Rob Pike claims that by mid-2008, 
the language was “mostly designed and the implementation (compiler, run-time) starting to work.”. 
After that, Ian Lance Taylor and Russ Cox joined the team in 2008


Go is an open-source programming language maintained by its community 
and a core team of developers working at Google. 
The 16th March of 2011 is the date of the first Go release. 
(It was named “r56”). 
Go version 1 was released on the 28th March of 2012.



Go (or Golang) was built by Google to solve the company’s problems. 
To better understands the reasons, 
it’s worth reading the keynote talk of Rob Pike:
